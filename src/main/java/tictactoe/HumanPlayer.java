...
public class HumanPlayer extends Player {
    ...
    /**
     * @brief Costruttore.
     * @param[in] mark Simbolo con cui è rappresentato il giocatore;
     *            deve essere Board.CELL_X oppure Board.CELL_O
     * @param[in] userInterface L'interfaccia utente
     */
    public HumanPlayer(int mark, UserInterface userInterface) {
        super(mark);
     ...
     * @return La mossa scelta, tra 0 e Board.SIZE-1.
     * @pre 
